...
public class Tank {
	...
	public Shape getCanon()            { return _canon; }
	...
	public float getCanonAngle()       { return _canonAngle; }	
	...
	public Bullet[] getBullets()                  { return _bullets; }
	public void     setBullets(Bullet[] _bullets) { this._bullets = _bullets; }
	...
	public void update(GameIO gameIO, int dt)
	{
		...
		if (gameIO.isMoving())
		{
			...
			_shape = _shape.transform(Transform.createTranslateTransform(dt * xMove, dt * yMove));
			_shape = _shape.transform(Transform.createRotateTransform((float) Math.toRadians(angleMove), _shape.getCenterX(), _shape.getCenterY()));
		}
